...
class AppColors {
  ...
  static const Color inputFocus = Color(0xFF1565C0);
  ...
  static Color overlayDark = Colors.black.withOpacity(0.4);
import 'dart:ui';
import 'package:flutter/material.dart';

class AppColors {
  // Primary palette (branding)
  static const Color primary = Color(0xff175fa4);
  ...
  // Shadows
  static const Color shadow = Color(0x33000000); // 20% opacity
}